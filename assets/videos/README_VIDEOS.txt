...
Please rename and place your videos/animations in the following locations:
...
OCP ACADEMY PROJECT:
- Main video: rename to "ocp_main.gif" and place in folder: /assets/videos/ocp/
- Animation 1: rename to "ocp_animation1.gif" and place in folder: /assets/videos/ocp/
- Animation 2: rename to "ocp_animation2.gif" and place in folder: /assets/videos/ocp/
...
- GIF format: Use standard GIF files optimized for web to reduce file size
- For GIFs, make sure they are properly exported and compressed for web use
